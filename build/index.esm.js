...
var LitNodeClient = /*#__PURE__*/function () {
  ...
  */
  ...
  _proto.verifyJwt = function verifyJwt(_ref) {
    var jwt = _ref.jwt;
    var pubKey = uint8arrayFromString(this.networkPubKey, 'base16');
    console.log('pubkey is ', pubKey);
    var jwtParts = jwt.split('.');
    var sig = uint8arrayFromString(jwtParts[2], 'base64url');
    ...
    var message = uint8arrayFromString(unsignedJwt);
