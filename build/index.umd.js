(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('jszip'), require('uint8arrays/from-string'), require('uint8arrays/to-string'), require('tweetnacl'), require('tweetnacl-util'), require('@ethersproject/contracts'), require('@ethersproject/wallet'), require('@ethersproject/providers'), require('@metamask/detect-provider'), require('pako')) :
	typeof define === 'function' && define.amd ? define(['jszip', 'uint8arrays/from-string', 'uint8arrays/to-string', 'tweetnacl', 'tweetnacl-util', '@ethersproject/contracts', '@ethersproject/wallet', '@ethersproject/providers', '@metamask/detect-provider', 'pako'], factory) :
	(global = global || self, global.litJsSdk = factory(global.jszip, global.uint8arrayFromString, global.uint8arrayToString, global.tweetnacl, global.tweetnaclUtil, global.contracts, global.wallet, global.providers, global.detectEthereumProvider, global.pako));
}(this, (function (JSZip, uint8arrayFromString, uint8arrayToString, nacl, naclUtil, contracts, wallet, providers, detectEthereumProvider, pako) {
