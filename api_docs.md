...
*   [LITCosmosChain][100]
    *   [Properties][101]
*   [LIT\_CHAINS][102]
*   [LIT\_SVM\_CHAINS][103]
*   [LIT\_COSMOS\_CHAINS][104]
*   [ALL\_LIT\_CHAINS][105]
*   [getVarType][106]
    *   [Parameters][107]
*   [checkType][108]
    *   [Parameters][109]
...
*   `params` **[Object][130]**&#x20;
    ...
    *   `params.callRequests` **[Array][133]<[CallRequest][127]>** The call requests to make.  The responses will be signed and returned.
    *   `params.chain` **[string][134]** The chain name of the chain that this contract is deployed on.  See LIT\_CHAINS for currently supported chains.
...
*   `params` **[Object][130]**&#x20;
    ...
    *   `params.accessControlConditions` **[Array][133]<[AccessControlCondition][80]>** The access control conditions that the user must meet to obtain this signed token.  This could be posession of an NFT, for example.  You must pass either accessControlConditions or evmContractConditions or solRpcConditions or unifiedAccessControlConditions.
    *   `params.evmContractConditions` **[Array][133]<[EVMContractCondition][82]>** EVM Smart Contract access control conditions that the user must meet to obtain this signed token.  This could be posession of an NFT, for example.  This is different than accessControlConditions because accessControlConditions only supports a limited number of contract calls.  evmContractConditions supports any contract call.  You must pass either accessControlConditions or evmContractConditions solRpcConditions or unifiedAccessControlConditions.
    *   `params.solRpcConditions` **[Array][133]<[SolRpcCondition][84]>** Solana RPC call conditions that the user must meet to obtain this signed token.  This could be posession of an NFT, for example.
    *   `params.unifiedAccessControlConditions` **[Array][133]<([AccessControlCondition][80] | [EVMContractCondition][82] | [SolRpcCondition][84])>** An array of unified access control conditions.  You may use AccessControlCondition, EVMContractCondition, or SolRpcCondition objects in this array, but make sure you add a conditionType for each one.  You must pass either accessControlConditions or evmContractConditions or solRpcConditions or unifiedAccessControlConditions.
    *   `params.chain` **[string][134]** The chain name of the chain that you are querying.  See ALL\_LIT\_CHAINS for currently supported chains.
    *   `params.authSig` **[AuthSig][90]** The authentication signature that proves that the user owns the crypto wallet address that meets the access control conditions.
    *   `params.resourceId` **[ResourceId][88]** The resourceId representing something on the web via a URL
...
*   `params` **[Object][130]**&#x20;
    ...
    *   `params.solRpcConditions` **[Array][133]<[SolRpcCondition][84]>** Solana RPC call conditions that the user must meet to obtain this signed token.  This could be posession of an NFT, for example.
    *   `params.unifiedAccessControlConditions` **[Array][133]<([AccessControlCondition][80] | [EVMContractCondition][82] | [SolRpcCondition][84])>** An array of unified access control conditions.  You may use AccessControlCondition, EVMContractCondition, or SolRpcCondition objects in this array, but make sure you add a conditionType for each one.  You must pass either accessControlConditions or evmContractConditions or solRpcConditions or unifiedAccessControlConditions.
    *   `params.toDecrypt` **[string][134]** The ciphertext that you wish to decrypt encoded as a hex string
    *   `params.chain` **[string][134]** The chain name of the chain that you are querying.  See ALL\_LIT\_CHAINS for currently supported chains.
    *   `params.authSig` **[AuthSig][90]** The authentication signature that proves that the user owns the crypto wallet address meets the access control conditions.
...
*   `params` **[Object][130]**&#x20;
    ...
    *   `params.chain` **[string][134]** The chain name of the chain that you are querying.  See ALL\_LIT\_CHAINS for currently supported chains.
    *   `params.authSig` **[AuthSig][90]** The authentication signature that proves that the user owns the crypto wallet address meets the access control conditions
    *   `params.symmetricKey` **[Uint8Array][135]** The symmetric encryption key that was used to encrypt the locked content inside the LIT as a Uint8Array.  You should use zipAndEncryptString or zipAndEncryptFiles to get this encryption key.  This key will be hashed and the hash will be sent to the LIT nodes.  You must pass either symmetricKey or encryptedSymmetricKey.
...
Returns **[Uint8Array][135]** The symmetricKey parameter that has been encrypted with the network public key.  Save this - you will need it to decrypt the content in the future.
...
*   `str` **[string][134]** The string to encrypt

Returns **[Promise][136]<[Object][130]>** A promise containing the encryptedString as a Blob and the symmetricKey used to encrypt it, as a Uint8Array.
...
*   `encryptedStringBlob` **([Blob][137] | File)** The encrypted string as a Blob
*   `symmKey` **[Uint8Array][135]** The symmetric key used that will be used to decrypt this.

Returns **[Promise][136]<[string][134]>** A promise containing the decrypted string
...
Returns **[Promise][136]<[Object][130]>** A promise containing an object with keys encryptedFile and symmetricKey.  encryptedFile is a Blob, and symmetricKey is a Uint8Array that can be used to decrypt the file.
...
Returns **[Promise][136]<[ArrayBuffer][138]>** A promise containing the decrypted file.  The file is an ArrayBuffer.
...
*   `string` **[string][134]** The string to zip and encrypt

Returns **[Promise][136]<[Object][130]>** A promise containing the encryptedZip as a Blob and the symmetricKey used to encrypt it, as a Uint8Array.  The encrypted zip will contain a single file called "string.txt"
...
Returns **[Promise][136]<[Object][130]>** A promise containing the encryptedZip as a Blob and the symmetricKey used to encrypt it, as a Uint8Array.  The encrypted zip will contain a folder "encryptedAssets" and all of the files will be inside it.
...
*   `params` **[Object][130]**&#x20;
    ...
    *   `params.litNodeClient` **[LitNodeClient][2]** An instance of LitNodeClient that is already connected
    *   `params.readme` **[string][134]** An optional readme text that will be inserted into readme.txt in the final zip file.  This is useful in case someone comes across this zip file and wants to know how to decrypt it.  This file could contain instructions and a URL to use to decrypt the file.

Returns **[Promise][136]<[Object][130]>** A promise containing an object with 3 keys: zipBlob, encryptedSymmetricKey, and symmetricKey.  zipBlob is a zip file that contains an encrypted file and the metadata needed to decrypt it via the Lit network.  encryptedSymmetricKey is the symmetric key needed to decrypt the content, encrypted with the Lit network public key.  You may wish to store encryptedSymmetricKey in your own database to support quicker re-encryption operations when adding additional access control conditions in the future, but this is entirely optional, and this key is already stored inside the zipBlob.  symmetricKey is the raw symmetric key used to encrypt the files.  DO NOT STORE IT.  It is provided in case you wish to create additional "OR" access control conditions for the same file.
...
*   `params` **[Object][130]**&#x20;
    ...
    *   `params.authSig` **[Object][130]** The authSig of the user.  Returned via the checkAndSignAuthMessage function
    *   `params.file` **([Blob][137] | File)** The zip file blob with metadata inside it and the encrypted asset
    *   `params.litNodeClient` **[LitNodeClient][2]** An instance of LitNodeClient that is already connected
    *   `params.additionalAccessControlConditions` &#x20;

Returns **[Promise][136]<[Object][130]>** A promise containing an object that contains decryptedFile and metadata properties.  The decryptedFile is an ArrayBuffer that is ready to use, and metadata is an object that contains all the properties of the file like it's name and size and type.
...
Returns **[Promise][136]<[Object][130]>** A promise containing the encryptedZip as a Blob and the symmetricKey used to encrypt it, as a Uint8Array string.
...
*   `encryptedZipBlob` **([Blob][137] | File)** The encrypted zip as a Blob
*   `symmKey` **[Uint8Array][135]** The symmetric key used that will be used to decrypt this zip.

Returns **[Promise][136]<[Object][130]>** A promise containing a JSZip object indexed by the filenames of the zipped files.  For example, if you have a file called "meow.jpg" in the root of your zip, you could get it from the JSZip object by doing this: const imageBlob = await decryptedZip\['meow.jpg'].async('blob')
...
*   `params` **[Object][130]**&#x20;
    ...
    *   `params.jwt` **[string][134]** A JWT signed by the LIT network using the BLS12-381 algorithm
...
*   `params` **[Object][130]**&#x20;
    ...
    *   `params.chain` **[string][134]** The chain you want to use.  Find the supported list of chains here: [https://developer.litprotocol.com/docs/supportedChains][139]
    *   `params.resources` **[Array][133]<[string][134]>** Optional and only used with EVM chains.  A list of resources to be passed to Sign In with Ethereum.  These resources will be part of the Sign in with Ethereum signed message presented to the user.
...
Returns **[AuthSig][90]** The AuthSig created or retrieved
...
*   `params` **[Object][130]**&#x20;
    ...
    *   `params.account` **[string][134]** The account to sign the message with
    *   `params.chainId` &#x20;
    *   `params.resources` &#x20;
...
*   `blob` **([Blob][137] | File)** The Blob or File to turn into a base64 string

Returns **[Promise][136]<[String][134]>** A promise that resolves to the base64 string
...
*   `base64String` **[String][134]** The base64 string that to turn into a Blob

Returns **[Blob][137]** A blob that contains the decoded base64 data

## uint8arrayToString

Convert a Uint8Array to a string.  Supports various encodings.  This is a re-export of [https://www.npmjs.com/package/uint8arrays][140] and you can find the list of supported encodings here [https://github.com/multiformats/multibase/blob/master/multibase.csv][141]

### Parameters

*   `uint8array` **[Uint8Array][135]** The Uint8Array to convert to a string
*   `encoding` **[String][134]** The encoding to use when converting the Uint8Array to a string.

Returns **[String][134]** The string representation of the Uint8Array

## uint8arrayFromString

Convert a string to a Uint8Array.  Supports various encodings.  This is a re-export of [https://www.npmjs.com/package/uint8arrays][140] and you can find the list of supported encodings here [https://github.com/multiformats/multibase/blob/master/multibase.csv][141]

### Parameters

*   `str` **[String][134]** The string to convert to a Uint8Array
*   `encoding` **[String][134]** The encoding to use when converting the string to a Uint8Array.

Returns **[String][134]** The Uint8Array representation of the data from the string
...
Returns **[string][134]** The data URL.  This is a string representation that can be used anywhere the original file would be used.
...
Returns **[Promise][136]<[string][134]>** A promise containing a human readable description of the access control conditions
...
Returns **[Promise][136]<[ArrayBuffer][138]>** A promise that resolves to an ArrayBuffer that contains the hash
...
*   `params` **[Object][130]**&#x20;
    ...
    *   `params.chain` **[string][134]** The chain that was minted on. "ethereum" and "polygon" are currently supported.
...
*   `params` **[Object][130]**&#x20;
    ...
    *   `params.tokenMetadata` **[string][134]** The token metadata of the token to be transferred.  Should include tokenId, tokenAddress, and chain
...
*   `params` **[Object][130]**&#x20;
    ...
    *   `params.title` **[string][134]** The title that will be used for the title tag in the outputted HTML
    ...
    *   `params.css` **[string][134]** Any CSS you would like to include in the outputted HTML
    ...
    *   `params.chain` **[string][134]** The chain that the corresponding NFT was minted on.  "ethereum" and "polygon" are currently supported.
    ...
    *   `params.tokenAddress` **[string][134]** The token address of the corresponding NFT for this LIT.  ERC721 and ERC 1155 tokens are currently supported.
...
*   `params` **[Object][130]**&#x20;
    ...
    *   `params.chain` **[string][134]** The chain to mint on.  "ethereum" and "polygon" are currently supported.
...
*   `params` **[Object][130]**&#x20;
    ...
    *   `params.title` **[string][134]** The title of the content being displayed
    *   `params.fileUrl` **[string][134]** The URL of the content that will be shown in the iFrame
    *   `params.className` **[string][134]** An optional DOM class name to add to the iFrame for styling
...
*   `contractAddress` **[string][134]** The address of the contract that will be queried
*   `chain` **[string][134]** The chain name of the chain that this contract is deployed on.  See LIT\_CHAINS for currently supported chains.
*   `standardContractType` **[string][134]** If the contract is an ERC20, ERC721, or ERC1155, please put that here
*   `method` **[string][134]** The smart contract function to call
...
*   `contractAddress` **[string][134]** The address of the contract that will be queried
*   `chain` **[string][134]** The chain name of the chain that this contract is deployed on.  See LIT\_CHAINS for currently supported chains.
*   `functionName` **[string][134]** The smart contract function to call
...
*   `method` **[string][134]** The Solana RPC method to be called.  You can find a list here: [https://docs.solana.com/developing/clients/jsonrpc-api][142]
...
*   `chain` **[string][134]** The chain name of the chain that this contract is deployed on.  See ALL\_LIT\_CHAINS for currently supported chains.  On Solana, we support "solana" for mainnet, "solanaDevnet" for devnet and "solanaTestnet" for testnet.
...
*   `path` **[string][134]** The RPC URL path that will be called.  This will typically contain any parameters you need for the call.  Note that you can use the special ":userAddress" parameter which will be replaced with the requesting user's wallet address, verified via message signature.  For example, this path would be used to get the requesting user's balance: "/cosmos/bank/v1beta1/balances/:userAddress"
*   `chain` **[string][134]** The chain name of the chain that this contract is deployed on.  See ALL\_LIT\_CHAINS for currently supported chains.  On Cosmos we currently support "cosmos" and "kyve"
...
*   `baseUrl` **[string][134]** The base url of the resource that will be authorized
*   `path` **[string][134]** The path of the url of the resource that will be authorized
*   `orgId` **[string][134]** The org id that the user would be authorized to belong to.  The orgId key must be present but it may contain an empty string if you don't need to store anything in it.
*   `role` **[string][134]** The role that the user would be authorized to have.  The role key must be present but it may contain an empty string if you don't need to store anything in it.
*   `extraData` **[string][134]** Any extra data you may want to store.  You may store stringified JSON in here, for example.  The extraData key must be present but it may contain an empty string if you don't need to store anything in it.
...
*   `sig` **[string][134]** The actual hex-encoded signature
*   `derivedVia` **[string][134]** The method used to derive the signature. Typically "web3.eth.personal.sign"
*   `signedMessage` **[string][134]** The message that was signed
*   `address` **[string][134]** The crypto wallet address that signed the message
...
*   `vmType` **[string][134]** Either EVM for an Ethereum compatible chain or SVM for a Solana compatible chain
*   `name` **[string][134]** The human readable name of the chain
...
*   `contractAddress` **[string][134]** The address of the token contract for the optional predeployed ERC1155 contract.  Only present on EVM chains.
*   `chainId` **[string][134]** The chain ID of the chain that this token contract is deployed on.  Used for EVM chains.
*   `name` **[string][134]** The human readable name of the chain
...
*   `value` **any**&#x20;
*   `allowedTypes` **[Array][133]<[String][134]>**&#x20;
*   `paramName` **[string][134]**&#x20;
*   `functionName` **[string][134]**&#x20;
...
*   `params` **[Object][130]**&#x20;
    ...
    *   `params.filename` **[string][134]** The name of the file
    *   `params.data` **[Uint8Array][135]** The actual file itself as a Uint8Array
    *   `params.mimetype` **[string][134]** The mime type of the file
...
*   `symmKey` **[Uint8Array][135]** The symmetric key to import

Returns **[Promise][136]\<CryptoKey>** A promise that resolves to the imported key
...
Returns **[Promise][136]\<CryptoKey>** A promise that resolves to the generated key
...
*   `receiverPublicKey` **[string][134]** The base64 encoded 32 byte public key.  The corresponding private key will be able to decrypt this blob
*   `data` **[Blob][137]** The blob to encrypt
*   `version` **[string][134]** The encryption algorithm to use.  This should be set to "x25519-xsalsa20-poly1305" as no other algorithms are implemented right now.
...
*   `receiverPrivateKey` **[string][134]** The base64 encoded 32 byte private key.  The corresponding public key was used to encrypt this blob
*   `version` **[string][134]** The encryption algorithm to use.  This should be set to "x25519-xsalsa20-poly1305" as no other algorithms are implemented right now.
...
*   `params` **[Object][130]**&#x20;
    ...
    *   `params.contractAddress` **[string][134]** The token contract address
    *   `params.chain` **[string][134]** The chain on which the token is deployed
...
*   `params` **[Object][130]**&#x20;
    ...
    *   `params.chain` **[string][134]** The chain on which to resolve the name
    *   `params.name` **[string][134]** The name to resolve

Returns **[string][134]** The resolved eth address
...
*   `params` **[Object][130]**&#x20;
    ...
    *   `params.chain` **[string][134]** The blockchain on which the access control conditions should be checked
    ...
    *   `params.objectUrl` **[string][134]** The url to the object, like an IPFS or Arweave url.
    *   `params.name` &#x20;
    *   `params.type` &#x20;
    *   `params.size` &#x20;
    *   `params.evmContractConditions` &#x20;
...
*   `to` **[string][134]** The address of the contract that will be queried
*   `from` **[string][134]** Optional.  The address calling the function.
*   `data` **[string][134]** Hex encoded data to send to the contract.
...
[140]: https://www.npmjs.com/package/uint8arrays

[141]: https://github.com/multiformats/multibase/blob/master/multibase.csv

[142]: https://docs.solana.com/developing/clients/jsonrpc-api
