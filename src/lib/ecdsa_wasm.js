...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('http://localhost:3050/ecdsa_wasm_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
    ...
    imports.wbg.__wbg_log_00fa6d531d56c191 = function() { return logError(function (arg0, arg1) {
